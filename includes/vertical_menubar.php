<div class="vertical-menu vertical-category-block">
    ...
    <div class="wrap-menu">
        <ul class="menu clone-main-menu">
            ...
            ?>
            <li class="menu-item menu-item-has-children has-megamenu">
                <a href="catagory.php?status=ctgdata&&id=<?php echo $ctgDataView['ctg_id']; ?>&&name=<?php echo $ctgDataView['ctg_name']; ?>" class="menu-name" data-title="<?php echo $ctgDataView['ctg_name']; ?>"><?php echo $ctgDataView['ctg_name']; ?> </a>
            </li>
            <?php
            }
            ?>
