...
if (isset($_GET['status'])){
    if ($_GET['status'] == 'spro'){
        $pdtId = $_GET['id'];
        $pdtCatagory= $obj_adminBack->viewSnglPdt($pdtId);
        $pdtDatas = array();
        $dbData = mysqli_fetch_assoc($pdtCatagory);
        $pdtDatas[]=$dbData;
    }
}

$catId = $dbData['ctg_id'];
$related_product = $obj_adminBack->relatedProduct($catId);
...
<div class="hero-section hero-background">
    <h1 class="page-title">
        <?php
        foreach ($pdtDatas as $prodView){
            echo $prodView['pdt_name'];
        }
        ?>
    </h1>
</div>
...
<div class="container">
    ...
    <div class="media">
        <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
            <li><img src="admin/uploads/<?php echo $prodView['pdt_file']; ?>" alt="" style="height: 500px; width: 500px;" width="500" height="500"></li>
        </ul>
    </div>
    <div class="product-attribute">
        ...
        <div class="rating">
            ...
            <b class="category">By: <?php
                echo $prodView['ctg_name'];
                ?></b>
        </div>
        <span class="sku">Sku: #<?php
            echo $prodView['pdt_id'];
            ?></span>
        <p class="excerpt">
            <?php
                echo $prodView['pdt_des'];
            ?>
        </p>
        <div class="price">
            <ins><span class="price-amount"><span class="currencySymbol">£</span>
                    <?php
                        echo $prodView['pdt_price'];
                    ?>
                </span></ins>
        </div>
    ...
    <div class="action-form">
        <div class="total-price-contain">
            <h3 >Product Price: £ <b><?php
                echo $prodView['pdt_price'];
                ?></b></h3>
            <p class="price"></p>
        </div>
        <div class="buttons">
            <input type="hidden" name="pdt_name" value="<?php echo $prodView['pdt_name']; ?>">
            <input type="hidden" name="pdt_price" value="<?php echo $prodView['pdt_price']; ?>">
            <input type="hidden" name="pdt_file" value="<?php echo $prodView['pdt_file']; ?>">
...
<!-- related products -->
    ...
    <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":0,"slidesToShow":5, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":20 }},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":10}}]}'>
        <?php
            while ($relPro = mysqli_fetch_assoc($related_product)){
        ?>
        <form action="addtocart.php" method="post">
        <li class="product-item">
            <div class="contain-product layout-default">
                <div class="product-thumb">
                    <a href="singleproduct.php?status=spro&&id=<?php echo $relPro['pdt_id']; ?>" class="link-to-product">
                        <img src="admin/uploads/<?php echo $relPro['pdt_file']; ?>" alt="dd"style="width: 270px; height: 270px" width="270" height="270" class="product-thumnail">
                    </a>
                </div>
                <div class="info">
                    <b class="categories"><?php echo $relPro['ctg_name']; ?></b>
                    <h4 class="product-title"><a href="singleproduct.php?status=spro&&id=<?php echo $relPro['pdt_id']; ?>" class="pr-name"><?php echo $relPro['pdt_name']; ?></a></h4>
                    <div class="price">
                        <ins><span class="price-amount"><span class="currencySymbol">£</span><?php echo $relPro['pdt_price']; ?></span></ins>
                    </div>
                    <div class="slide-down-box">
                        <p class="message"><?php echo $relPro['pdt_des']; ?></p>
                        <div class="buttons">
                            <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                            <input type="hidden" name="pdt_name" value="<?php echo $relPro['pdt_name']; ?>">
                            <input type="hidden" name="pdt_price" value="<?php echo $relPro['pdt_price']; ?>">
                            <input type="hidden" name="pdt_file" value="<?php echo $relPro['pdt_file']; ?>">
                            <input type="submit" name="addtocart" value="add to cart now !" class="btn add-to-cart-btn">
                            <a href="singleproduct.php?status=spro&&id=<?php echo $relPro['pdt_id']; ?>" class="btn compare-btn"><i class="fa fa-eye" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
            </div>
